...
{#if audios[currentTrack].author == 'الشيخ أبو مدين الغوث' || audios[currentTrack].author == 'الشيخ عز الدين بن عبد السلام المقدسي' || audios[currentTrack].author == 'الشيخ عبد الغني النابلسي'}
